    ...
    return (
        <div className='left_scrollbar_container scroller'>
            ...
            <div className='Hide-Menu'>
                <div onClick={() => router('/')}>
                    <HiMiniHome style={{ fontSize: "23px", marginBottom: "10px" }} />
                    <p>Home</p>
                </div>
                <div >
                    <BsCursorFill style={{ fontSize: "23px", marginBottom: "10px" }} />
                    <p>Shorts</p>
                </div>
                <div>
                    <MdSubscriptions style={{ fontSize: "23px", marginBottom: "10px" }} />
                    <p>Subscription</p>
                </div>
                <div >
                    <TbBoxMultiple style={{ fontSize: "23px", marginBottom: "10px" }} />
                    <p>You</p>
                </div>
                <div>
                    <GoHistory style={{ fontSize: "23px", marginBottom: "10px" }} />
                    <p>History</p>
                </div>
            </div>
        </div>
